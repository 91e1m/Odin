...
object FuckDiorite : Module(
    ...
    private val pillarBasedColor by BooleanSetting("Pillar Based", default = true, description = "Swaps the diorite in the pillar to a corresponding color.").withDependency { !schitzo }
