...
object TeammatesHighlight : Module(
    ...
    private val backgroundColor by ColorSetting("Background Color", color = Colors.MINECRAFT_DARK_GRAY.withAlpha(0.5f), true, description = "The color of the nametag background").withDependency { showName && nameStyle == 1 }
    private val accentColor by ColorSetting("Accent Color", color = Color.BLUE, true, description = "The color of the nametag accent").withDependency { showName && nameStyle == 1 }
