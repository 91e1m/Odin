...
object DianaHelper : Module(
    ...
    private val guessColor by ColorSetting("Guess Color", color = Color.WHITE, allowAlpha = true, description = "Color of the guess text.")
    ...
    private val tracerColor by ColorSetting("Tracer Line Color", color = Color.WHITE, allowAlpha = true, description = "Color of the tracer line.").withDependency { tracer }
