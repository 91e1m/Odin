...
object TickTimers : Module(
    ...
    private val symbolDisplay by BooleanSetting("Display Symbol", default = true, description = "Displays s or t after the timers.")
    private val showPrefix by BooleanSetting("Show Prefix", default = true, description = "Shows the prefix of the timers.")
