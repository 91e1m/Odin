...
enum class WitherDragonsEnum (
    ...
    Orange(Vec3(85.0, 14.0, 56.0), AxisAlignedBB(72.0, 8.0,  47.0, 102.0,28.0, 77.0),'6', Colors.MINECRAFT_GOLD,
    ...
    Purple(Vec3(56.0, 14.0, 125.0), AxisAlignedBB(45.5, 13.0, 113.5,68.5, 23.0, 136.5),'5', Colors.MINECRAFT_DARK_PURPLE,
