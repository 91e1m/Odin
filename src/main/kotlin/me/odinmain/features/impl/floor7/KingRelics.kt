...
object KingRelics {
    ...
    enum class Relic (
        ...
        Purple("PURPLE_KING_RELIC", '5', Color.MINECRAFT_DARK_PURPLE, Vec3(56.5, 8.5, 132.5), Vec3(54.0, 7.0, 41.0)),
        Blue("BLUE_KING_RELIC", 'b', Color.MINECRAFT_BLUE, Vec3(91.5, 6.5, 94.5), Vec3(59.0, 7.0, 44.0)) ,
        Orange("ORANGE_KING_RELIC", '6', Color.MINECRAFT_GOLD, Vec3(90.5, 6.5, 56.5), Vec3(57.0, 7.0, 42.0)),
